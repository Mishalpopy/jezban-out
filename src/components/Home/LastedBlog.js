...
const LastedBlog = () => {
  return (
    <>
      {/* <!-- lasted blog start  --> */}
      <div className="tp-lasted-blog pt-90">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="tp-blog">
                ...
                <div className="tp-blog__meta pt-25 pb-15">
                  <span>
                    <Link to="/">Pest Control Tips</Link>
                  </span>
                </div>
                <h3 className="tp-blog__title">
                  <Link to="/">
                  10 Effective Pest Control Tips for a Pest-Free Home
                  </Link>
                </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="tp-blog">
                ...
                <div className="tp-blog__meta pt-25 pb-15">
                  <span>
                    <Link to="/">Seasonal Pest Management</Link>
                  </span>
                </div>
                <h3 className="tp-blog__title">
                  <Link to="/">
                  Surviving the Seasons: Your Guide to Year-Round Pest Management
                  </Link>
                </h3>
                <Link className="tp-btn-sm-black" to="/">
                  <span>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="tp-blog">
                ...
                <div className="tp-blog__meta pt-25 pb-15">
                  <span>
                    <Link to="/">Eco-Friendly Pest Solutions</Link>
                  </span>
                </div>
                <h3 className="tp-blog__title">
                  <Link to="/">
                  Going Green: The Future of Pest Control - Eco-Friendly Pest Solutions
                  </Link>
                </h3>
                <Link className="tp-btn-sm-black" to="/">
                  <span>
