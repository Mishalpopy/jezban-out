          ...
          <div className="row g-0 justify-content-end">
            <div className="col-xl-4 col-lg-12 tp-modify-width d-block">
              <div className="tp-section-title-sm-box tp-white-text grey-bg-3 hide-content">
                ...
                Precision Pest Eradication
                </span>
                <h3 className="tp-section-title-sm tp-white-text-sm mb-5">
                Effective Pest Control Solutions
                </h3>
                <p>
                Our targeted approach ensures pest eradication with precision, protecting your space and well-being from unwanted intruders.
                </p>
              ...
              <div className="tp-section-title-sm-box tp-white-text black-bg hide-content">
                ...
                <p>
                We employ environmentally responsible methods, guaranteeing effective pest management that cares for your surroundings and health.
                </p>
                <Link className="tp-btn-sm" to="/">
                  <span>
                    <svg
